...
- **Expression**: a sequence of symbols that evolves independently of any external code.
...
- **Status**: whether a program is still running, halted or was paused due to reaching an unknown rule.
...
- **Cycler**: a program that repeats its configuration indefinitely.
